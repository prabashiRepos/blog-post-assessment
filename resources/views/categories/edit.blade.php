                                ...
                                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                    ...
                                    <div class="col-span-3 sm:col-span-2">
                                        ...
                                        <div class="mt-1 flex rounded-md">
                                            <input required type="text" name="name" id="name" class="block w-full rounded-md border-gray-300" placeholder="Enter name here" value="{{ old('name', $category->name) }}">
                                        </div>
                                    </div>
                                    <div class="col-span-3 sm:col-span-2">
                                        ...
                                        <div class="mt-1">
                                            <textarea id="description" name="description" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full rounded-md border-gray-300" placeholder="Enter description here">{{ old('description', $category->description) }}</textarea>
                                        </div>
                                    </div>
                                </div>
