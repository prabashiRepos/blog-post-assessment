                ...
                <div class="text-gray-100 bg-gray-900 body-font shadow w-full">
                    <div class="container mx-auto flex flex-wrap p-5 flex-row">
                        ...
                        <div class="w-2/3 inline-flex justify-end ml-0">
                            <a href="{{ route('blogs.edit',$blog->id) }}" class="bg-indigo-700 hover:bg-indigo-500 text-white ml-4 py-2 px-3 rounded-lg">Edit</a>
                            <form class="inline" action="{{ route('blogs.destroy',$blog->id) }}" method="post">
                        ...
                        <div class="grid gap-6 m-8 md:grid-cols-1">
                            ...
                            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                                <div>
                                    ...
                                    <div class="text-lg font-semibold text-gray-700 dark:text-gray-200">
                                        @if($blog->image)<img class="w-60" src="{{Storage::disk('public')->url($blog->image)}}" />@endif
                                    </div>
                                </div>
                            </div>
                        </div>
