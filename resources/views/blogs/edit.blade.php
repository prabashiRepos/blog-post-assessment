                                ...
                                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                    ...
                                    <div class="col-span-3 sm:col-span-2">
                                        ...
                                        <div class="mt-1 flex rounded-md">
                                            <input required type="text" name="title" id="title" class="block w-full rounded-md border-gray-300" placeholder="Enter title here" value="{{ old('title', $blog->title) }}">
                                        </div>
                                    </div>
                                    <div class="col-span-3 sm:col-span-2">
                                        ...
                                        <div class="mt-1">
                                            <textarea id="content" name="content" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full rounded-md border-gray-300" placeholder="Enter content here">{{ old('content', $blog->content) }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-span-3 sm:col-span-2">
                                        ...
                                        <div class="mt-1 flex rounded-md">
                                            <input required type="text" name="category" id="category" class="block w-full rounded-md border-gray-300" placeholder="Enter category here" value="{{ old('category', $blog->category) }}">
                                        </div>
                                    </div>
                                    <div class="col-span-3 sm:col-span-2">
